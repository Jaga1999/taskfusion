...
export class ExportService {
    ...
    async exportToExcel(tasks, options) {
        ...
        tasks.forEach(task => {
            ...
            worksheet.addRow({
                ...
                completedAt: ((_a = task.getCompletedAt()) === null || _a === void 0 ? void 0 : _a.toISOString()) || '',
